(function($) {
    ...
    var $BUILD = $("<li class='build'><a class='link'></a><span class='desc'></span><span class='date'></span><span><a class='dsym'></a></span></li>");
    ...
    OTA.$build = function(title, name, description, date) {
       ...
       $(".link", $build).text(name).attr("href", url + ".ipa");
	...
	//$(".dsym", $build).text(" [.framework.dSYM] ");
        $(".dsym", $build).attr("href", url + ".dSYM.zip");
